...
document.addEventListener("click", (e) => {
    // Check if the popup is active and if the click is outside the popup and not on an image
    if (galleryPopup.classList.contains("active") && !galleryPopup.contains(e.target) && !e.target.closest(".gallery-img")) {
